...
/// `ContentView` y con ella el view model: el monitor global de Option (que vive adentro, vía
/// `GlobalHotkeyServicing`) capturaba `self` como `weak`, así que el atajo dejaba de andar en
